...
//        Log.d("EventLandingPageUser", "Extras: " + extras + String.valueOf(extras.size()));
    ...
    public void deleteImage(String eventID) {
        ...
        if (eventID == null || eventID.trim().isEmpty()) {
            ...
            Toast.makeText(EventLandingPageUserActivity.this, "Event ID cannot be null or empty.", Toast.LENGTH_SHORT).show();

            Log.e("DeleteImageDebug", "Event ID is null or empty!");
        ...
        // Sanitize the event ID and construct the filename

        String sanitizedEventID = eventID.replaceAll("[^a-zA-Z0-9_]", "_").trim();

        String fileName = "event_posters/event_posters_" + sanitizedEventID + ".jpg";

        StorageReference imageRef = FirebaseStorage.getInstance().getReference().child(fileName);



        Log.d("DeleteImageDebug", "Attempting to delete file: " + fileName);
        ...
        imageRef.getMetadata()
                ...
                .addOnSuccessListener(metadata -> {
                    ...
                    imageRef.delete()
                            ...
                            .addOnSuccessListener(aVoid -> {
                                ...
                                Log.d("DeleteImageDebug", "File deleted successfully: " + fileName);
                            ...
                            .addOnFailureListener(e -> {
                                ...
                                Log.e("DeleteImageDebug", "Error deleting file: " + fileName, e);
                ...
                .addOnFailureListener(e -> {
                    ...
                    Toast.makeText(EventLandingPageUserActivity.this, "File does not exist at the specified location.", Toast.LENGTH_SHORT).show();

                    Log.e("DeleteImageDebug", "File not found: " + fileName, e);
