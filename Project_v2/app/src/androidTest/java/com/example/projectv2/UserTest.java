...
public class UserTest {
    ...
    public void setUp() {
        ...
        userWithFullConstructor = new User(true, false, "admin@example.com", "Admin", "User", true, true, 9876543210L, "deviceID456");
    }
...
//        assertEquals("Admin", userWithFullConstructor.getFirstName());
    ...
    public void testSetters() {
        ...
        userWithDefaultConstructor.setPhoneNumber(5555555555L);
